...
public class ShoppingCartDirective extends WebDirective
{
  ...
  {
/* 30 */     Website web = getWeb(env, params, this.websiteMng);
/* 31 */     RequestContext ctx = getContext(env);
/* 32 */     Map origMap = 
/* 33 */       DirectiveUtils.addParamsToVariable(env, params);
/* 34 */     includeTpl(web, ctx, env);
/* 35 */     DirectiveUtils.removeParamsFromVariable(env, params, origMap);
  }
...
/* 42 */     env.include(tpl, "UTF-8", true);
  }

  @Autowired
  public void setWebsiteMng(WebsiteMng websiteMng)
  {
/* 49 */     this.websiteMng = websiteMng;
  }
}
