...
/* 44 */     Long channelId = getChannelId(params);
/* 45 */     Pagination pagination = this.shopArticleMng.getPageForTag(web.getId(), 
/* 46 */       channelId, getPageNo(env), getCount(params));
/* 47 */     Map paramWrap = new HashMap(
/* 48 */       params);
/* 49 */     paramWrap.put("tag_pagination", 
...
/* 73 */       return Long.valueOf(((TemplateNumberModel)parentId).getAsNumber().longValue());
/*    */     }
