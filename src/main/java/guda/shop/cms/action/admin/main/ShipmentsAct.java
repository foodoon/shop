...
/*     */     }
/*  49 */     model.addAttribute("order", this.manager.findById(id).getIndent());
/*  50 */     model.addAttribute("shipments", this.manager.findById(id));
/*  51 */     return "Shipments/edit";
/*     */   }
/*     */ 
...
/*  61 */     log.info("save Shipments id={}", bean.getId());
...
/*  73 */     log.info("update Shipments id={}.", bean.getId());
...
/*     */     }
/*  84 */     Shipments[] beans = this.manager.deleteByIds(ids);
/*  85 */     for (Shipments bean : beans) {
/*  86 */       log.info("delete Shipments id={}", bean.getId());
/*     */     }
...
/* 126 */       return true;
/*     */     }
/* 128 */     Shipments entity = this.manager.findById(id);
