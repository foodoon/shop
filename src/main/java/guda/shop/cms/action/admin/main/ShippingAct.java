...
/*     */ 
/*  33 */   @RequestMapping({"/shipping/v_list.do"})
...
/*     */     }
/*  51 */     model.addAttribute("shipping", this.manager.findById(id));
...
/*  61 */       return errors.showErrorPage(model);
/*     */     }
/*  63 */     if (bean.getIsDefault().booleanValue()) {
/*  64 */       List list = this.manager.getList(Long.valueOf(1L), true);
...
/*     */     }
/*  83 */     if (bean.getIsDefault().booleanValue()) {
/*  84 */       List list = this.manager.getList(Long.valueOf(1L), true);
/*  85 */       for (int i = 0; i < list.size(); i++) {
/*  86 */         ((Shipping)list.get(i)).setIsDefault(Boolean.valueOf(false));
/*  87 */         this.manager.update(bean);
/*     */       }
/*     */     }
/*  90 */     bean.setLogistics(this.logisticsMng.findById(logisticsId));
/*  91 */     bean = this.manager.update(bean);
...
/* 104 */     for (Shipping bean : beans) {
/* 105 */       log.info("delete Shipping. id={}", bean.getId());
/*     */     }
...
/*     */   {
/* 113 */     WebErrors errors = validatePriority(wids, priority, request);
/* 114 */     if (errors.hasErrors()) {
/* 115 */       return errors.showErrorPage(model);
/*     */     }
/* 117 */     this.manager.updatePriority(wids, priority);
...
/* 126 */     bean.setWebsite(SiteUtils.getWeb(request));
/* 127 */     return errors;
/*     */   }
/*     */ 
...
/* 157 */       return errors;
/*     */     }
/* 159 */     if (errors.ifEmpty(priority, "priority")) {
/* 160 */       return errors;
/*     */     }
...
/* 164 */       return errors;
/*     */     }
/* 166 */     int i = 0; for (int len = wids.length; i < len; i++) {
/* 167 */       vldExist(wids[i], errors);
/* 168 */       if (priority[i] == null) {
/* 169 */         priority[i] = Integer.valueOf(0);
/*     */       }
/*     */     }
/* 172 */     return errors;
/*     */   }
...
/* 177 */     return errors.ifNotExist(entity, Shipping.class, id);
/*     */   }
/*     */ }
