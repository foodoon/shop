...
/* 28 */     Map adminMap = AdminMap.adminmap;
/* 29 */     model.addAttribute("map1", adminMap);
/* 30 */     Set keySet = adminMap.keySet();
/* 31 */     for (String username : keySet) {
/* 32 */       ((Integer)adminMap.get(username)).intValue();
/*    */     }
/*    */ 
/* 36 */     return "admin/uplocklist";
/*    */   }
/*    */ 
...
/* 41 */     AdminMap.unLoadAdmin(username);
/* 42 */     ResponseUtils.renderJson(response, "解锁成功 !");
/* 43 */     return null;
/*    */   }
/*    */ }
