...
/*     */ 
/*  37 */   @RequestMapping({"/discuss/v_list.do"})
...
/*  38 */     userName = StringUtils.trim(userName);
/*  39 */     String productName = RequestUtils.getQueryParam(request, "productName");
/*  40 */     productName = StringUtils.trim(productName);
/*  41 */     Pagination pagination = this.manager.getPage(null, userName, productName, startTime, endTime, 
...
/*     */     }
/*     */ 
/*  51 */     model.addAttribute("startTime", startTime);
/*  52 */     model.addAttribute("endTime", endTime);
/*     */ 
/*  54 */     model.addAttribute("pagination", pagination);
/*  55 */     model.addAttribute("pageNo", pageNo);
/*  56 */     return "discuss/list"; }
/*     */ 
/*     */   @RequestMapping({"/discuss/v_add.do"})
/*     */   public String add(ModelMap model)
/*     */   {
/*  61 */     return "discuss/add";
/*     */   }
/*     */ 
...
/*     */     }
/*  70 */     model.addAttribute("discuss", this.manager.findById(id));
/*  71 */     model.addAttribute("pageNo", pageNo);
/*  72 */     return "discuss/edit";
/*     */   }
/*     */ 
...
/*     */     }
/*     */ 
/*  82 */     log.info("save Discuss id={}", bean.getId());
...
/*     */     }
/*  93 */     bean = this.manager.update(bean);
/*  94 */     log.info("update Discuss id={}.", bean.getId());
/*  95 */     return list(null, null, pageNo, request, model);
/*     */   }
/*     */ 
/*     */   @RequestMapping({"/discuss/o_delete.do"})
/*     */   public String delete(Long[] ids, Integer pageNo, HttpServletRequest request, ModelMap model)
/*     */   {
/* 101 */     WebErrors errors = validateDelete(ids, request);
/* 102 */     if (errors.hasErrors()) {
/* 103 */       return errors.showErrorPage(model);
/*     */     }
/* 105 */     Discuss[] beans = this.manager.deleteByIds(ids);
/* 106 */     for (Discuss bean : beans) {
/* 107 */       log.info("delete Discuss id={}", bean.getId());
/*     */     }
/* 109 */     return list(null, null, pageNo, request, model);
/*     */   }
/*     */ 
...
/* 121 */     Website web = SiteUtils.getWeb(request);
/* 122 */     if (vldExist(id, web.getId(), errors)) {
/* 123 */       return errors;
/*     */     }
/* 125 */     return errors;
/*     */   }
...
/* 140 */     errors.ifEmpty(ids, "ids");
/* 141 */     for (Long id : ids) {
/* 142 */       vldExist(id, web.getId(), errors);
/*     */     }
/* 144 */     return errors;
/*     */   }
/*     */ 
...
/* 149 */       return true;
/*     */     }
/* 151 */     Discuss entity = this.manager.findById(id);
/* 152 */     if (errors.ifNotExist(entity, Discuss.class, id)) {
/* 153 */       return true;
/*     */     }
/*     */ 
/* 159 */     return false;
