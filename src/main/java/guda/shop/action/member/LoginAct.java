...
/*  48 */     if (!StringUtils.isBlank(returnUrl)) {
/*  49 */       model.addAttribute("returnUrl", returnUrl);
/*  50 */       if (!StringUtils.isBlank(message)) {
...
/*     */   {
/*  64 */     Website web = SiteUtils.getWeb(request);
/*  65 */     WebErrors errors = WebErrors.create(request);
/*     */     try
/*     */     {
/*  68 */       ShopMember member = this.loginSvc.memberLogin(request, response, web, username, password);
/*  69 */       if (member == null) {
/*  70 */         return "redirect:/";
/*     */       }
/*  72 */       log.info("member '{}' login success.", username);
/*  73 */       if (!StringUtils.isBlank(returnUrl))
/*  74 */         return "redirect:" + returnUrl;
/*  75 */       if (!StringUtils.isBlank(redirectUrl)) {
...
/*  99 */     return web.getTplSys("member", MessageResolver.getMessage(request, "tpl.loginInput", new Object[0]));
/*     */   }
/*     */ 
/*     */   public Integer errorRemaining(String username) {
/* 103 */     if (StringUtils.isBlank(username)) {
/* 104 */       return null;
/*     */     }
...
/*     */   {
/* 117 */     this.loginSvc.logout(request, response);
