...
/*  40 */     model.putAll(RequestUtils.getQueryParams(request));
/*  41 */     ShopFrontHelper.setCommon(request, model, web);
/*  42 */     ShopFrontHelper.frontPage(request, model);
/*  43 */     String q = RequestUtils.getQueryParam(request, "q");
...
/*  61 */     return web.getTplSys("shop", MessageResolver.getMessage(request, "tpl.searchResult", new Object[0]));
/*     */   }
/*     */ 
/*     */   public String encodeFilename(HttpServletRequest request, String fileName)
/*     */   {
/*  66 */     String agent = request.getHeader("USER-AGENT");
/*     */     try
/*     */     {
