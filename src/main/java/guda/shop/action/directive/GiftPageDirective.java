...
/*    */   {
/* 42 */     Website web = getWeb(env, params, this.websiteMng);
/* 43 */     Pagination pagination = this.giftMng.getPageGift(getPageNo(env), getCount(params));
/* 44 */     Map paramWrap = new HashMap(
/* 45 */       params);
/* 46 */     paramWrap.put("tag_pagination", 
/* 47 */       ObjectWrapper.DEFAULT_WRAPPER.wrap(pagination));
/* 48 */     paramWrap.put("tag_list", ObjectWrapper.DEFAULT_WRAPPER.wrap(pagination.getList()));
/* 49 */     Map origMap = 
/* 50 */       DirectiveUtils.addParamsToVariable(env, paramWrap);
/* 51 */     if (isInvokeTpl(params))
/* 52 */       includeTpl("shop", "ArticlePage", web, params, env);
/*    */     else {
/* 54 */       renderBody(env, loopVars, body);
/*    */     }
/* 56 */     DirectiveUtils.removeParamsFromVariable(env, paramWrap, origMap);
/*    */   }
/*    */ 
...
/*    */   {
/* 69 */     this.giftMng = giftMng;
/*    */   }
/*    */ 
/*    */   @Autowired
/*    */   public void setWebsiteMng(WebsiteMng websiteMng) {
/* 74 */     this.websiteMng = websiteMng;
/*    */   }
/*    */ }
