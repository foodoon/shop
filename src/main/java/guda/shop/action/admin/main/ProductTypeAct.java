...
/*     */ 
/*  31 */   @RequestMapping({"/type/v_list.do"})
...
/*     */     }
/*  47 */     model.addAttribute("productType", this.manager.findById(id));
/*  48 */     return "type/edit";
/*     */   }
/*     */ 
...
/*  71 */     log.info("update ProductType. id={}.", bean.getId());
/*  72 */     return list(request, model);
/*     */   }
/*     */ 
...
/*  82 */     for (ProductType bean : beans) {
/*  83 */       log.info("delete ProductType. id={}", bean.getId());
/*     */     }
/*  85 */     return list(request, model);
/*     */   }
/*     */ 
/*     */   private WebErrors validateSave(ProductType bean, HttpServletRequest request) {
/*  89 */     WebErrors errors = WebErrors.create(request);
/*  90 */     bean.setWebsite(SiteUtils.getWeb(request));
/*  91 */     return errors;
/*     */   }
/*     */ 
...
/* 122 */     errors.ifNotExist(entity, ProductType.class, id);
/*     */   }
/*     */ }
