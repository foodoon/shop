...
/*     */ 
/*  42 */   @RequestMapping({"/member/v_list.do"})
...
/*  51 */     List groupList = this.shopMemberGroupMng.getList(
/*  52 */       SiteUtils.getWebId(request));
/*     */ 
/*  54 */     List userDegreeList = this.shopDictionaryMng.getListByType(Long.valueOf(1L));
/*     */ 
/*  56 */     List familyMembersList = this.shopDictionaryMng.getListByType(Long.valueOf(2L));
/*     */ 
/*  58 */     List incomeDescList = this.shopDictionaryMng.getListByType(Long.valueOf(3L));
/*     */ 
/*  60 */     List workSeniorityList = this.shopDictionaryMng.getListByType(Long.valueOf(4L));
/*     */ 
/*  62 */     List degreeList = this.shopDictionaryMng.getListByType(Long.valueOf(5L));
/*     */ 
/*  64 */     model.addAttribute("groupList", groupList);
/*  65 */     model.addAttribute("userDegreeList", userDegreeList);
/*  66 */     model.addAttribute("familyMembersList", familyMembersList);
/*  67 */     model.addAttribute("incomeDescList", incomeDescList);
/*  68 */     model.addAttribute("workSeniorityList", workSeniorityList);
/*  69 */     model.addAttribute("degreeList", degreeList);
/*  70 */     return "member/add";
/*     */   }
/*     */ 
...
/*     */     }
/*     */ 
/*  83 */     bean = this.manager.register(username, password, email, Boolean.valueOf(true), null, 
...
/*     */ 
/* 102 */     List userDegreeList = this.shopDictionaryMng.getListByType(Long.valueOf(1L));
/*     */ 
/* 104 */     List familyMembersList = this.shopDictionaryMng.getListByType(Long.valueOf(2L));
/*     */ 
...
/*     */ 
/* 112 */     ShopMember member = this.manager.findById(id);
/* 113 */     model.addAttribute("groupList", groupList);
/* 114 */     model.addAttribute("member", member);
/* 115 */     model.addAttribute("groupList", groupList);
/* 116 */     model.addAttribute("userDegreeList", userDegreeList);
/* 117 */     model.addAttribute("familyMembersList", familyMembersList);
/* 118 */     model.addAttribute("incomeDescList", incomeDescList);
/* 119 */     model.addAttribute("workSeniorityList", workSeniorityList);
/* 120 */     model.addAttribute("degreeList", degreeList);
/* 121 */     return "member/edit";
/*     */   }
/*     */ 
...
/*     */     }
/* 133 */     bean = this.manager.update(bean, groupId, userDegreeId, 
...
/* 158 */     bean.setWebsite(web);
/* 159 */     if (vldUsername(username, errors)) {
/* 160 */       return errors;
/*     */     }
/* 162 */     if (vldEmail(email, errors)) {
/* 163 */       return errors;
/*     */     }
/* 165 */     return errors;
/*     */   }
...
/* 171 */     if (vldExist(id, web.getId(), errors)) {
/* 172 */       return errors;
/*     */     }
/* 174 */     return errors;
/*     */   }
...
/* 181 */     if (vldEmailUpdate(id, email, errors)) {
/* 182 */       return errors;
/*     */     }
...
/* 194 */     for (Long id : ids) {
/* 195 */       vldExist(id, web.getId(), errors);
/*     */     }
/* 197 */     return errors;
/*     */   }
/*     */ 
...
/* 205 */       return true;
/*     */     }
/* 207 */     ShopMember entity = this.manager.findById(id);
/* 208 */     if (errors.ifNotExist(entity, ShopMember.class, id)) {
/* 209 */       return true;
/*     */     }
/* 211 */     if (!entity.getWebsite().getId().equals(webId)) {
/* 212 */       errors.notInWeb(ShopMember.class, id);
/* 213 */       return true;
/*     */     }
/* 215 */     return false;
/*     */   }
...
/* 220 */       ShopMember member = this.manager.findById(id);
/* 221 */       if ((!member.getEmail().equals(email)) && 
...
/* 231 */     if (errors.ifNotEmail(email, "email", 100)) {
/* 232 */       return true;
/*     */     }
...
/* 242 */     if (errors.ifNotUsername(username, "username", 3, 100)) {
/* 243 */       return true;
/*     */     }
