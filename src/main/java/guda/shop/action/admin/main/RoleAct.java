...
/*    */   {
/* 26 */     List list = this.manager.getList();
...
/* 38 */     model.addAttribute("role", this.manager.findById(id));
/* 39 */     return "role/edit";
/*    */   }
/*    */ 
...
/*    */   {
/* 45 */     bean = this.manager.save(bean, splitPerms(perms));
...
/*    */   {
/* 52 */     bean = this.manager.update(bean, splitPerms(perms));
...
/* 67 */         for (String p : StringUtils.split(perm, ',')) {
/* 68 */           if (!StringUtils.isBlank(p)) {
/* 69 */             set.add(p);
/*    */           }
/*    */         }
/*    */       }
