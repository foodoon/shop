...
(function (bC, bs) {
    ...
    function s(d, a, b) {
        b[0].type = d;
        return cc.event.handle.apply(a, b)
    }
    ...
    cc.fn = cc.prototype = {
        ...
        slice: function () {
            return this.pushStack(cx.apply(this, arguments), "slice", cx.call(arguments).join(","))
        },
        map: function (a) {
            return this.pushStack(cc.map(this, function (b, d) {
                return a.call(b, d, b)
            }))
        },
        end: function () {
            return this.prevObject || cc(null)
        },
        push: bz,
        sort: [].sort,
        splice: [].splice
    ...
    cc.extend = cc.fn.extend = function () {
        ...
        if (typeof h !== "object" && !cc.isFunction(h)) {
            h = {}
        }
        if (b === d) {
            h = this;
        ...
        for (; d < b; d++) {
            if ((g = arguments[d]) != null) {
                for (i in g) {
                    ...
                    e = g[i];
                    if (h !== e) {
                        if (a && e && (cc.isPlainObject(e) || cc.isArray(e))) {
                            f = f && (cc.isPlainObject(f) || cc.isArray(f)) ? f : cc.isArray(e) ? [] : {};
                            h[i] = cc.extend(a, f, e)
                        } else {
                            if (e !== bs) {
                                h[i] = e
    ...
    cc.extend({
        ...
        ready: function () {
            if (!cc.isReady) {
                if (!bp.body) {
                    return setTimeout(cc.ready, 13)
                }
                cc.isReady = true;
                if (cv) {
                    for (var a, b = 0; a = cv[b++];) {
                        a.call(bp, cc)
                    }
                    cv = null
                }
        ...
        isFunction: function (a) {
            return a0.call(a) === "[object Function]"
        },
        isArray: function (a) {
            return a0.call(a) === "[object Array]"
        },
        isPlainObject: function (a) {
            if (!a || a0.call(a) !== "[object Object]" || a.nodeType || a.setInterval) {
                return false
            }
            if (a.constructor && !bn.call(a, "constructor") && !bn.call(a.constructor.prototype, "isPrototypeOf")) {
                return false
            }
            var b;
            for (b in a) {
        ...
        each: function (g, b, d) {
            ...
            if (d) {
                if (e) {
                    for (a in g) {
                        if (b.apply(g[a], d) === false) {
                            break
                        }
                    }
                } else {
                    for (; f < h;) {
                        if (b.apply(g[f++], d) === false) {
                            break
                        }
                    }
                }
        ...
        proxy: function (d, a, b) {
            ...
            if (d) {
                a.guid = d.guid = d.guid || a.guid || cc.guid++
            }
            return a
        },
        uaMatch: function (a) {
    ...
    if (cc.browser.webkit) {
        cc.browser.safari = true
    }
    if (X) {
        cc.inArray = function (a, b) {
            return X.call(b, a)
        }
    }
    bZ = cc(bp);
    if (bp.addEventListener) {
        Q = function () {
            bp.removeEventListener("DOMContentLoaded", Q, false);
            cc.ready()
        }
    } else {
        if (bp.attachEvent) {
            Q = function () {
                if (bp.readyState === "complete") {
                    bp.detachEvent("onreadystatechange", Q);
                    cc.ready()
                }
            }
        }
    ...
    (function () {
        ...
        if (!(!g || !g.length || !a)) {
            ...
            if (i.attachEvent && i.fireEvent) {
                i.attachEvent("onclick", function b() {
                    cc.support.noCloneEvent = false;
                    i.detachEvent("onclick", b)
                });
    ...
    cc.extend({
        ...
        data: function (e, b, a) {
            if (!(e.nodeName && cc.noData[e.nodeName.toLowerCase()])) {
                e = e == bC ? br : e;
                var f = e[G], d = cc.cache;
                if (!f && typeof b === "string" && a === bs) {
                    return null
                }
                f || (f = ++cs);
                if (typeof b === "object") {
                    e[G] = f;
                    d[f] = cc.extend(true, {}, b)
                } else {
                    if (!d[f]) {
                        e[G] = f;
                        d[f] = {}
    ...
    cc.fn.extend({
        queue: function (a, b) {
            ...
            if (b === bs) {
                return cc.queue(this[0], a)
            }
            return this.each(function () {
                var d = cc.queue(this, a, b);
                a === "fx" && d[0] !== "inprogress" && cc.dequeue(this, a)
            })
        },
        dequeue: function (a) {
            return this.each(function () {
    ...
    cc.fn.extend({
        attr: function (a, b) {
            return b3(this, a, b, true, cc.attr)
        },
        ...
        addClass: function (f) {
            if (cc.isFunction(f)) {
                return this.each(function (k) {
                    var l = cc(this);
                    l.addClass(f.call(this, k, l.attr("class")))
                })
            }
        ...
        removeClass: function (h) {
            if (cc.isFunction(h)) {
                return this.each(function (k) {
                    var j = cc(this);
                    j.removeClass(h.call(this, k, j.attr("class")))
                })
            }
        ...
        hasClass: function (d) {
            ...
            for (var a = 0, b = this.length; a < b; a++) {
                if ((" " + this[a].className + " ").replace(bU, " ").indexOf(d) > -1) {
                    return true
                }
            }
            return false
        ...
        val: function (h) {
            if (h === bs) {
                ...
                if (d) {
                    ...
                    if (bb.test(d.type) && !cc.support.checkOn) {
                ...
                if (this.nodeType === 1) {
                    ...
                    if (cc.isArray(m) && bb.test(this.type)) {
                        ...
                        if (cc.nodeName(this, "select")) {
                            ...
                            cc("option", this).each(function () {
                                this.selected = cc.inArray(cc(this).val(), j) >= 0
                            });
                            if (!j.length) {
    ...
    cc.event = {
        add: function (e, f, j, m) {
            if (!(e.nodeType === 3 || e.nodeType === 8)) {
                if (e.setInterval && e !== bC && !e.frameElement) {
                    e = bC
                }
                var l, n;
                if (j.handler) {
        ...
        trigger: function (e, g, i, h) {
            ...
            try {
                if (!(i && i.nodeName && cc.noData[i.nodeName.toLowerCase()])) {
                    if (i["on" + j] && i["on" + j].apply(i, g) === false) {
                        e.result = false
                    }
                }
            } catch (b) {
    ...
    var J = bp.removeEventListener ?
        function (d, a, b) {
            d.removeEventListener(a, b, false)
        } :
        function (d, a, b) {
            d.detachEvent("on" + a, b)
        };
    cc.Event = function (a) {
        if (!this.preventDefault) {
            return new cc.Event(a)
        }
        if (a && a.type) {
    ...
    cc.Event.prototype = {
        ...
        stopImmediatePropagation: function () {
            this.isImmediatePropagationStopped = b6;
    ...
    var cf = function (d) {
            ...
            try {
                ...
                if (a !== this) {
                    d.type = d.data;
                    cc.event.handle.apply(this, arguments)
                }
            } catch (b) {
            }
        },
    ...
    cc.each({mouseenter: "mouseover", mouseleave: "mouseout"},
        function (a, b) {
            cc.event.special[a] = {
                setup: function (d) {
                    cc.event.add(this, b, d && d.selector ? cb : cf, a)
                },
                teardown: function (d) {
                    cc.event.remove(this, b, d && d.selector ? cb : cf)
                }
            }
        });
    if (!cc.support.submitBubbles) {
        cc.event.special.submit = {
            ...
            teardown: function () {
                cc.event.remove(this, ".specialSubmit")
            }
        }
    }
    if (!cc.support.changeBubbles) {
            ...
            bJ = function (d) {
                ...
                if (a === "radio" || a === "checkbox") {
                    ...
                    if (a === "select-multiple") {
                        b = d.selectedIndex > -1 ? cc.map(d.options, function (e) {
                            return e.selected
                        }).join("-") : ""
                    } else {
        ...
        cc.event.special.change = {
            ...
            teardown: function () {
                cc.event.remove(this, ".specialChange");
                return cl.test(this.nodeName)
            }
        };
    ...
    bp.addEventListener && cc.each(
        ...
        function (d, a) {
            function b(e) {
                e = cc.event.fix(e);
                e.type = a;
                return cc.event.handle.call(this, e)
            }

            cc.event.special[a] = {
                setup: function () {
                    this.addEventListener(d, b, true)
                },
                teardown: function () {
                    this.removeEventListener(d, b, true)
                }
            }
        }
    );
        ...
        toggle: function (d) {
            ...
            return this.click(
                cc.proxy(d, function (f) {
                        var e = (cc.data(this, "lastToggle" + d.guid) || 0) % b;
                        cc.data(this, "lastToggle" + d.guid, e + 1);
                        f.preventDefault();
    ...
    bC.attachEvent && !bC.addEventListener && bC.attachEvent("onunload",
        function () {
            for (var a in cc.cache) {
                if (cc.cache[a].handle) {
                    try {
                        cc.event.remove(cc.cache[a].handle.elem)
                    } catch (b) {
                    }
                }
            }
    ...
    (function () {
        ...
        var g = /((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^[\]]*\]|['"][^'"]*['"]|[^[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g, f = 0, i = Object.prototype.toString, h = false, l = true;
        [0, 0].sort(function () {
            l = false;
            return 0
        });
        var j = function (x, B, v, S) {
            v = v || [];
            var C = B = B || bp;
            ...
            for (var U = [], E, y, z, I, H = true, u = n(B), M = x; (g.exec(""), E = g.exec(M)) !== null;) {
                M = E[3];
                U.push(E[1]);
                if (E[2]) {
                    I = E[3];
            ...
            if (U.length > 1 && p.exec(x)) {
                if (U.length === 2 && k.relative[U[0]]) {
                    y = a(U[0] + U[1], B)
                } else {
                    for (y = k.relative[U[0]] ? [B] : j(U.shift(), B); U.length;) {
                        x = U.shift();
                        if (k.relative[x]) {
                            x += U.shift()
                        }
                ...
                if (!S && U.length > 1 && B.nodeType === 9 && !u && k.match.ID.test(U[0]) && !k.match.ID.test(U[U.length - 1])) {
                    E = j.find(U.shift(), B, u);
            ...
            if (i.call(z) === "[object Array]") {
                if (H) {
                    if (B && B.nodeType === 1) {
                        for (x = 0; z[x] != null; x++) {
                            if (z[x] && (z[x] === true || z[x].nodeType === 1 && q(B, z[x]))) {
                                v.push(y[x])
                            }
                        }
                    } else {
                        for (x = 0; z[x] != null; x++) {
                            z[x] && z[x].nodeType === 1 && v.push(y[x])
                        }
                    }
                } else {
                    v.push.apply(v, z)
        ...
        var k = j.selectors = {
                ...
                match: {
                    ...
                    PSEUDO: /:((?:[\w\u00c0-\uFFFF-]|\\.)+)(?:\((['"]?)((?:\([^\)]+\)|[^\(\)]*)+)\2\))?/}, leftMatch: {}, attrMap: {"class": "className", "for": "htmlFor"}, attrHandle: {href: function (u) {
                    return u.getAttribute("href")
                }
                },
                relative: {"+": function (x, z) {
                    var v = typeof z === "string", u = v && !/\W/.test(z);
                    v = v && !u;
                    if (u) {
                        z = z.toLowerCase()
                    }
                    u = 0;
                    for (var y = x.length, B; u < y; u++) {
                        if (B = x[u]) {
                            for (; (B = B.previousSibling) && B.nodeType !== 1;) {
                            }
                            x[u] = v || B && B.nodeName.toLowerCase() === z ? B || false : B === z
                        }
                    }
                    v && j.filter(z, x, true)
                }, ">": function (x, z) {
                    ...
                    if (v && !/\W/.test(z)) {
                        ...
                        for (var u = 0, y = x.length; u < y; u++) {
                            ...
                            if (B) {
                                v = B.parentNode;
                                x[u] = v.nodeName.toLowerCase() === z ? v : false
                            }
                        }
                    } else {
                        u = 0;
                        for (y = x.length; u < y; u++) {
                            if (B = x[u]) {
                                x[u] = v ? B.parentNode : B.parentNode === z
                            }
                        }
                        v && j.filter(z, x, true)
                    }
                    ...
                    if (typeof z === "string" && !/\W/.test(z)) {
                        var B = z = z.toLowerCase();
                        y = d
                    }
                    y("parentNode", z, u, x, B, v)
                }, "~": function (x, z, v) {
                    var u = f++, y = e;
                    if (typeof z === "string" && !/\W/.test(z)) {
                        var B = z = z.toLowerCase();
                ...
                preFilter: {
                    ...
                    PSEUDO: function (x, y, v, z, u) {
                        if (x[1] === "not") {
                            ...
                            if (k.match.POS.test(x[0]) || k.match.CHILD.test(x[0])) {
                                return true
                            }
                        }
                        return x
                ...
                filter: {
                        ...
                        switch (z) {
                            ...
                            case"nth":
                                ...
                                if (y && (y.sizcache !== x || !C.nodeIndex)) {
                                    var v = 0;
                                    for (u = y.firstChild; u; u = u.nextSibling) {
                                        if (u.nodeType === 1) {
                                            u.nodeIndex = ++v
                                        }
                                    }
                    ...
                    ATTR: function (x, y) {
                        var v = y[1];
                        x = k.attrHandle[v] ? k.attrHandle[v](x) : x[v] != null ? x[v] : x.getAttribute(v);
                        v = x + "";
                        var u = y[2];
                        y = y[4];
                    ...
                    POS: function (x, y, v, z) {
                        var u = k.setFilters[y[2]];
                        if (u) {
                            return u(x, v, y, z)
                        }
                    }
        ...
        for (var o in k.match) {
            ...
            k.leftMatch[o] = new RegExp(/(^(?:.|\r|\n)*?)/.source + k.match[o].source.replace(/\\(\d+)/g, function (u, v) {
                return"\\" + (v - 0 + 1)
            }))
        }
        var t = function (u, v) {
        ...
        /**/
        var q = bp.compareDocumentPosition ? function (u, v) {
            ...
            a = function (x, z) {
                var v = [], u = "", y;
                for (z = z.nodeType ? [z] : z; y = k.match.PSEUDO.exec(x);) {
                    u += y[0];
                    x = x.replace(k.match.PSEUDO, "")
                }
                x = k.relative[x] ? x + "*" : x;
                y = 0;
                for (var B = z.length; y < B; y++) {
                    j(x, z[y], v)
                }
                return j.filter(u, v)
            };
        cc.find = j;
        cc.expr = j.selectors;
        cc.expr[":"] = cc.expr.filters;
        cc.unique = j.uniqueSort;
        cc.text = b;
        cc.isXMLDoc = n;
        cc.contains = q
    })();

    var bN = /Until$/, T = /^(?:parents|prevUntil|prevAll)/, bm = /,/;
    cx = Array.prototype.slice;
    /**/
    var bI = function (a, b, d) {
        if (cc.isFunction(b)) {
            return cc.grep(a, function (f, g) {
                return !!b.call(f, g, f) === d
            })
        } else {
            if (b.nodeType) {
                return cc.grep(a, function (f) {
                    return f === b === d
                })
            } else {
                if (typeof b === "string") {
                    var e = cc.grep(a, function (f) {
                        return f.nodeType === 1
                    });
                    if (bq.test(b)) {
    ...
    cc.fn.extend({
        ...
        is: function (a) {
            return !!a && cc.filter(a, this).length > 0
        },
            ...
            if (cc.isArray(f)) {
                ...
                if (j && f.length) {
                    ...
                    for (var e = f.length; g < e; g++) {
                        d = f[g];
                        a[d] || (a[d] = cc.expr.match.POS.test(d) ? cc(d, h || this.context) : d)
                    }
                    for (; j && j.ownerDocument && j !== h;) {
                        for (d in a) {
                            g = a[d];
                            if (g.jquery ? g.index(j) > -1 : cc(j).is(g)) {
                                i.push({selector: d, elem: j});
                                delete a[d]
                            }
                        }
                        j = j.parentNode
        ...
        index: function (a) {
            if (!a || typeof a === "string") {
                return cc.inArray(this[0], a ? cc(a) : this.parent().children())
            }
    ...
    cc.each({
            ...
            parents: function (a) {
                return cc.dir(a, "parentNode")
            },
            parentsUntil: function (d, a, b) {
                return cc.dir(d, "parentNode", b)
            },
            next: function (a) {
                return cc.nth(a, 2, "nextSibling")
            },
            prev: function (a) {
                return cc.nth(a, 2, "previousSibling")
            },
            nextAll: function (a) {
                return cc.dir(a, "nextSibling")
            },
            prevAll: function (a) {
                return cc.dir(a, "previousSibling")
            },
            nextUntil: function (d, a, b) {
                return cc.dir(d, "nextSibling", b)
            },
            prevUntil: function (d, a, b) {
                return cc.dir(d, "previousSibling", b)
            },
            siblings: function (a) {
                return cc.sibling(a.parentNode.firstChild, a)
            },
            children: function (a) {
                return cc.sibling(a.firstChild)
            },
            contents: function (a) {
        ...
        function (a, b) {
            cc.fn[a] = function (e, d) {
                var f = cc.map(this, b, e);
                bN.test(a) || (d = e);
                if (d && typeof d === "string") {
                    f = cc.filter(d, f)
                }
                f = this.length > 1 ? cc.unique(f) : f;
                if ((this.length > 1 || bm.test(d)) && T.test(a)) {
                    f = f.reverse()
                }
    ...
    cc.extend({
        filter: function (d, a, b) {
            ...
            return cc.find.matches(d, a)
        },
        dir: function (a, b, d) {
            var e = [];
            for (a = a[b]; a && a.nodeType !== 9 && (d === bs || a.nodeType !== 1 || !cc(a).is(d));) {
    ...
    cc.fn.extend({
        ...
        wrapInner: function (a) {
            if (cc.isFunction(a)) {
                return this.each(
                    function (b) {
                        cc(this).wrapInner(a.call(this, b))
                    }
                )
            }
            return this.each(
                function () {
                    var b = cc(this), d = b.contents();
        ...
        after: function () {
            if (this[0] && this[0].parentNode) {
                ...
                if (arguments.length) {
                    ...
                    a.push.apply(a, cc(arguments[0]).toArray());
                    return a
                }
            }
        },
        ...
        remove: function (a, b) {
            for (var d = 0, e; (e = this[d]) != null; d++) {
                if (!a || cc.filter(a, [e]).length) {
                    if (!b && e.nodeType === 1) {
                        cc.cleanData(e.getElementsByTagName("*"));
                        cc.cleanData([e])
                    }
                    ...
                    try {
                        for (var b = 0, d = this.length; b < d; b++) {
                            if (this[b].nodeType === 1) {
                                cc.cleanData(this[b].getElementsByTagName("*"));
                                this[b].innerHTML = a
                            }
                        }
                    } catch (e) {
    ...
    /**/
    cc.extend({
        clean: function (d, f, h, k) {
            f = f || bp;
            if (typeof f.createElement === "undefined") {
                f = f.ownerDocument || f[0] && f[0].ownerDocument || bp
            }
            ...
            if (h) {
                for (l = 0; j[l]; l++) {
                    if (k && cc.nodeName(j[l], "script") && (!j[l].type || j[l].type.toLowerCase() === "text/javascript")) {
                        ...
                        j[l].nodeType === 1 && j.splice.apply(j, [l + 1, 0].concat(cc.makeArray(j[l].getElementsByTagName("script"))));
                        h.appendChild(j[l])
                    }
                }
            }
    ...
    cc.fn.css = function (a, b) {
        return b3(this, a, b, true, function (e, d, f) {
            if (f === bs) {
                return cc.curCSS(e, d)
            }
            if (typeof f === "number" && !bL.test(d)) {
                f += "px"
            }
            cc.style(e, d, f)
        })
    ...
    cc.extend({
        ...
        curCSS: function (f, b, e) {
            ...
            if (!cc.support.opacity && b === "opacity" && f.currentStyle) {
                d = bu.test(f.currentStyle.filter || "") ? parseFloat(RegExp.$1) / 100 + "" : "";
                return d === "" ? "1" : d
            }
            if (N.test(b)) {
                b = b7
        ...
        load: function (f, b, e) {
            ...
            if (b) {
                if (cc.isFunction(b)) {
                    ...
                    if (typeof b === "object") {
                        b = cc.param(b, cc.ajaxSettings.traditional);
                        d = "POST"
                    }
                }
            }
    ...
    cc.extend({
        ...
        getScript: function (a, b) {
            return cc.get(a, null, b, "script")
        },
        getJSON: function (d, a, b) {
            return cc.get(d, a, b, "json")
        },
        ...
        ajax: function (v) {
            function x() {
                a.success && a.success.call(h, l, f, r);
                a.global && b("ajaxSuccess", [r, a])
            }
            ...
            function b(z, B) {
                (a.context ? cc(a.context) : cc.event).trigger(z, B)
            }
                ...
                if (!g) {
                    ...
                    q.onload = q.onreadystatechange = function () {
                        if (!m && (!this.readyState || this.readyState === "loaded" || this.readyState === "complete")) {
                            ...
                            p && q.parentNode && p.removeChild(q)
                        }
                    }
                }
        ...
        handleError: function (a, b, d, e) {
            ...
            if (a.global) {
                (a.context ? cc(a.context) : cc.event).trigger("ajaxError", [b, a, e])
            }
        },
        active: 0,
        ...
        param: function (f, b) {
            function e(i, h) {
                if (cc.isArray(h)) {
                    cc.each(h, function (k, j) {
                        b || /\[\]$/.test(i) ? d(i, j) : e(i + "[" + (typeof j === "object" || cc.isArray(j) ? k : "") + "]", j)
                    })
                } else {
                    !b && h != null && typeof h === "object" ? cc.each(h, function (k, j) {
                        e(i + "[" + k + "]", j)
                    }) : d(i, h)
                }
            }
            ...
            function d(i, h) {
                h = cc.isFunction(h) ?
                    h() : h;
                a[a.length] = encodeURIComponent(i) + "=" + encodeURIComponent(h)
            }

            var a = [];
            if (b === bs) {
                b = cc.ajaxSettings.traditional
            }
            ...
            return this[d.queue === false ? "each" : "queue"](
                function () {
                    ...
                    for (g in e) {
                        ...
                        if (cc.isArray(e[g])) {
                            (h.specialEasing = h.specialEasing || {})[g] = e[g][1];
                            e[g] = e[g][0]
                        }
                    }
                    if (h.overflow != null) {
    ...
    cc.extend({
        speed: function (a, b, d) {
            ...
            e.duration = cc.fx.off ? 0 : typeof e.duration === "number" ?
                e.duration : cc.fx.speeds[e.duration] || cc.fx.speeds._default;
            e.old = e.complete;
            e.complete = function () {
                e.queue !== false && cc(this).dequeue();
                cc.isFunction(e.old) && e.old.call(this)
            };
            return e
        },
        easing: {
    ...
    cc.fx.prototype = {
        ...
        custom: function (e, b, a) {
            ...
            var d = this;
            f.elem = this.elem;
            if (f() && cc.timers.push(f) && !b2) {
                b2 = setInterval(cc.fx.tick, 13)
            }
        },
        show: function () {
    ...
    cc.extend(cc.fx, {
        tick: function () {
            for (var a = cc.timers, b = 0; b < a.length; b++) {
                a[b]() || a.splice(b--, 1)
            }
            a.length || cc.fx.stop()
        },
    ...
    if (cc.expr && cc.expr.filters) {
        cc.expr.filters.animated = function (a) {
            return cc.grep(cc.timers, function (b) {
                return a === b.elem
            }).length
        }
    }
        ...
        function (a) {
            if (!a.ERROR) {
                jQuery(a.info).each(function () {
                    if (noSyncKey[this.name]) {
                        return
                    }
                    if (noSyncKeyIfExists[this.name] && jQuery.cookie(this.name)) {
                        return
                    }
    ...
    if (typeof currSiteType != "undefined" && currSiteType != 1) {
        ...
        jQuery.getJSON(a,
            function (e) {
                ...
                jQuery(e.info).each(
                    function () {
                        d[this.name] = decodeURIComponent(this.value)
                    }
                );
                c.apply(d)
            }
...
(function (a) {
    ...
    var YHD = {init: function () {
        ...
        if (l != null && n != null) {
            jQuery(o).jqm({onHide: function (a) {
    ...
    }, popwin: function (k, j, i, m, n, h) {
        YHD.init();
        var l = jQuery("#yhd_pop_win");
        if (k != null) {
            jQuery(l).html(k)
        }
        YHD.initPosition(l, j, i, m, n);
        jQuery(l).jqm({overlay: 10, overlayClass: "pop_win_bg", modal: true, toTop: true}).jqmShow().jqmAddClose(".popwinClose");
        jQuery(".pop_win_bg").bgiframe()
    }, popwinId: function (m, n, k, j, h, i) {
        var l = jQuery("#" + m);
        YHD.initPosition(l, k, j, h, i);
        l.css("height", "auto");
        l.css("z-index", "1000");
        l.show();
        if (!n) {
        ...
        jQuery("." + n, l).bind("click", function () {
            l.hide()
        })
    }, popTitleWin: function (p, m, o, l, h, j, k) {
        var n = '<H3 class="pop_win_title" >' + p + '<img src="' + imagePath + '/icon_close.jpg" class="popwinClose"/></H3>';
        n += '<div class="pop_win_content" class="content">' + m + "</div>";
        n += '<div style="clear:both"></div>';
        YHD.popwin(n, o, l, h, j, k)
    ...
    }, alertPrescriotion: function (s, q, m, o, l) {
        var r = "";
        if (s == null) {
            r = ""
        } else {
            if (s == 14) {
                r = "本品为处方药，为了用药安全，已经将您的个人信息进行登记，谢谢配合！如需用药指导帮助请联系在线客服！"
            } else {
                if (s == 16 || s == 17 || s == 18) {
                    r = "本品为处方药，不能网络订购；如需购买，请到药店凭处方购买或咨询客服!"
                } else {
                    r = "本品为处方药,请在提交订单前上传处方,如需用药师指导帮助,请联系在线客服！"
                }
            }
        }
        var t = "确定";
        if (s != null && (s == 16 || s == 17 || s == 18)) {
            t = "关闭"
        }
        var n = '<input name="submit" class="pop_win_button popwinClose fl" id="pop_win_ok_btn" type="button"   value="' + t + '" />';
        ...
        h += '<div class="aptab_center" align="center"><p class="pt10">' + r + "</p>";
        h += '<div class="pt5" style="width:160px;">';
        if (s != null && (s == 16 || s == 17 || s == 18)) {
            h += p;
            h += n
        } else {
        ...
        h += '<p class="pt10 mb10" style="color:#b00000;font-weight:bold;">免费客服热线:400-007-0958</p></div>';
        h += '<div class="aptab_footer"><img src="' + imagePath + '/popwin/aptab_footer.jpg"></div></div>';
        if (m == null) {
            m = 300
        }
        YHD.popwin(h, m, o, null, null, l);
        if (q) {
            if (s != null && s != 16 && s != 17 && s != 18) {
                jQuery("#pop_win_ok_btn").click(function () {
                    q()
    ...
    }, confirm: function (m, j, k, l, h, n) {
        var i = '<div class="aptab" style="left: 0px; top: 0px;"><div class="aptab_header"><ul><li class="fl pl10">温馨提示</li><li class="popwinClose fr btn_close mr10"><img src="' + imagePath + '/popwin/icon_close.jpg"></li><li class="popwinClose fr mr5 color_white"><a href="###">关闭</a></li></ul> <div class="clear"></div></div>';
        i += '<div class="aptab_center" align="center"><p class="pt10">' + m + "</p>";
        i += '<div align="center"><input name="submit" class="pop_win_button popwinClose" id="pop_win_ok_btn" type="button"   value="确 定" /><input name="submit"   class="pop_win_button popwinClose" type="button" id="pop_win_cancel_btn" value="返回购物车" /></div>';
        i += "</div>";
        i += '<div class="aptab_footer"><img src="' + imagePath + '/popwin/aptab_footer.jpg"></div></div>';
        if (l == null) {
            l = 300
        }
        YHD.popwin(i, l, h, null, null, n);
        if (j) {
            jQuery("#pop_win_ok_btn").click(function () {
                j()
            })
    ...
    }, confirmToLottery: function (m, j, k, l, h, n) {
        var i = "" + m + "";
        if (l == null) {
            l = 300
        }
    ...
    }, ajax: function (i, j, m, h) {
        var l = jQuery("#yhd_pop_win");
        l.jqm({ajax: i, ajaxP: j, ajaxText: '<img src="' + imagePath + '/loading.gif" />', onLoad: m, modal: true, toTop: true, closeClass: "popwinClose"}).jqmShow();
        var n = (jQuery(window).width() - l.width()) / 2 + jQuery(window).scrollLeft() + "px";
        var k = (jQuery(window).height() - l.height()) / 2 + jQuery(window).scrollTop() + "px";
        jQuery(l).css("left", n).css("top", k)
    }, ajaxPointAlert: function (i, j, m, h) {
        var l = jQuery("#yhd_pop_win");
        l.jqm({ajax: i, ajaxP: j, ajaxText: '<img src="' + imagePath + '/loading.gif" />', onLoad: m, modal: true, toTop: true, closeClass: "popwinClose"}).jqmShow();
        var n = "436.5px";
        var k = (jQuery(window).height() - l.height()) / 2 + jQuery(window).scrollTop() + "px";
    ...
    function DrawImage(g, f, h) {
        var e = new Image();
        e.src = g.src;
        if (e.width > 0 && e.height > 0) {
            if (e.width / e.height >= f / h) {
                if (e.width > f) {
                    g.width = f;
                    g.height = (e.height * f) / e.width
                } else {
                    g.width = e.width;
                    g.height = e.height
                }
    ...
    function bindLinkClickTracker(d, e) {
        ...
        f.click(function () {
            ...
            a = e + "_" + encodeURIComponent(jQuery.trim(a));
            addTrackPositionToCookie("1", a)
        })
    };

    function addToCart(j, k, i, l, h) {
        var g = URLPrefix.central + "/product/isContractProduct.do?productId=" + k + "&merchantId=" + i + "&callback=?";
        jQuery.getJSON(g, function (b) {
            if (b.ERROR) {
            } else {
                if (b) {
                    var a = parseInt(b.code);
                    if (a == 1) {
                        addIphone4ToCart(j, k, i, l, h)
                    } else {
    ...
    function addIphone4ToCart(i, j, h, f, g) {
        if (jQuery("#validateProductId").length > 0) {
            jQuery("#validateProductId").attr("value", j)
        }
        if (jQuery.cookie("prompt_flag") == null && jQuery("#buyPromptDiv").length > 0) {
            YHD.popwinId("buyPromptDiv");
            jQuery("#validate").bind("click", function () {
                doAddIphone4ToCart(i, j, h, f)
            })
        } else {
            doAddIphone4ToCart(i, j, h, f)
        }
    ...
    function doAddIphone4ToCart(h, e, g, f) {
        window.location.href = URLPrefix.central + "/product/detail.do?productID=" + e + "&merchantID=" + g
    }

    function doAddToCart(k, l, i, g, h) {
        if (isPrescriotionForCheckAddToCart(l)) {
            var j = parseInt(jQuery("#buyButton_" + l).attr("specialType"));
            YHD.alertPrescriotion(j, function () {
                processDoAddToCart(k, l, i, g, h)
            })
        } else {
            processDoAddToCart(k, l, i, g, h)
        }
    ...
    function isPrescriotionForCheckAddToCart(d) {
        var e = false;
        if (jQuery("#buyButton_" + d).size() > 0) {
            var f = jQuery("#buyButton_" + d).attr("specialType");
            if (f != null && (parseInt(f) >= 14 && parseInt(f) <= 18)) {
                e = true
            }
        }
        return e
    ...
    function processDoAddToCart(k, l, j, n, i) {
        if (i) {
            var h = URLPrefix.central + "/product/addGlobalProduct2.do?productID=" + l + "&merchantId=" + j + "&productNum=" + n + "&callback=?";
                ...
                if (a.ERROR) {
                    ...
                    if (a.code && a.code != "undefined" && a.code != "") {
                        if (a.code.indexOf("buyEGiftCard.do") > -1) {
                            window.location.href = URLPrefix.central + a.code
                        }
                    }
                    afterAddToCart(a)
                }
    ...
    function floatCartByScrollBar(m) {
        if (m.code && m.code != "undefined" && m.code != "") {
            if (m.code.indexOf("buyEGiftCard.do") > -1) {
                window.location.href = URLPrefix.central + m.code
            }
        }
        if (m.value.indexOf("addProductFailed") > -1) {
            var k = jQuery(window).width() / 2 + jQuery(window).scrollLeft() + "px";
            var o = jQuery(window).height() / 2 + jQuery(window).scrollTop() + "px";
            YHD.popwin(m.value, jQuery("#yhd_pop_win").width(), jQuery("#yhd_pop_win").height(), o, k)
        } else {
            var l = function () {
            ...
            jQuery("#showMiniCart").mouseenter(l);
            reloadMiniCart(sliderMiniCart);
            var n = jQuery("#scrollCart");
            var p = jQuery(".nav_bar").offset().top;
            var i = jQuery(window).scrollTop();
            if (n.length > 0 && i > p) {
                var j = function () {
                    if (jQuery(window).scrollTop() <= p) {
                        jQuery(n).css({position: "relative", left: "auto", right: "auto", top: "auto"})
                    } else {
                        if (jQuery.browser.msie && jQuery.browser.version == "6.0") {
                            ...
                            jQuery(n).css("position", "absolute").css("left", b).css("top", a)
                        } else {
                            jQuery(n).css({right: 0, top: "10px", position: "fixed"})
                        }
                    }
                };
                j();
                jQuery(window).unbind("scroll", j);
                jQuery(window).bind("scroll", j)
            }
        }
    }
    ...
    function buildCartNumber() {
        jQuery("#in_cart_num").text(getCartProductNum())
    }
    ...
    function getCartProductNum() {
        ...
        var d = 0;
        if (c) {
            d = parseInt(jQuery.cookie("cart_cookie__" + c + "_getAllProductNum"))
        }
        return d ? d : 0
    }
    ...
    function reloadMiniCart(g) {
        var f = typeof(URLPrefix.central) != "undefined" ? URLPrefix.central : "http://www.yihaodian.com";
        var h = this;
        var e = f + "/cart/ajaxGetGlobalMiniCartInfo.do?callback=?";
    ...
    function afterLoadMiniCart(l) {
        var h = jQuery("#showMiniCart");
        if (l.totalNum && l.items) {
            var j = parseInt(l.totalNeedPoint);
            var i = parseInt(l.totalNeedZhongxinPoint);
            var m = parseFloat(l.totalNeedMoney);
            var k = parseFloat(l.totalAmount) + m;
            k = k.toFixed(2);
            var n = '<ul><li class="pr_num">共<strong>' + l.totalNum + "</strong>件商品 金额总计(预估):<strong>";
            if (j && j > 0) {
                n += j + "积分（1号店）+"
            }
            if (i && i > 0) {
            ...
            n += k + "</strong>元</li>";
            jQuery(l.items).each(function (f) {
                var c = this;
                var e = parseInt(c.itemType);
                var b = parseInt(c.warningType);
                var s = parseInt(c.pointBuyType);
                var t = c.hasPromoteLimitAttachedKey;
                if (b > 0) {
                    n += '<li id="mini_cart_li_' + f + '" style="border:1px solid #FF6666;background: none repeat scroll 0 0 #ffe1e1;">'
                } else {
                    n += '<li id="mini_cart_li_' + f + '">'
                }
                n += '<a traget="_blank" href="' + URLPrefix.central + "/product/" + c.productId + "_" + c.merchantId + '"><img src="' + c.picture4040URL + '"></a><a class="t" "_blank" href="' + URLPrefix.central + "/product/" + c.productId + "_" + c.merchantId + '">' + c.cnName + "</a>";
                n += '<span class="fr">';
                var r = parseInt(c.num);
                var a = c.currentPrice;
                a = a.toFixed(2);
                if (s && s > 0) {
                    var g = parseFloat(c.needPoint / r);
                    g = g.toFixed(0);
                    if (s == 1) {
                        n += "<strong>" + g + "积分(1号店)x" + r + "</strong>"
                    } else {
                        if (s == 2) {
                            var d = parseFloat(c.needMoney / r);
                            d = d.toFixed(0);
                            n += "<strong>(" + g + "积分+¥" + d + ")x" + r + "</strong>"
                        } else {
                            if (s == 3) {
                                n += "<strong>" + g + "积分(中信)x" + r + "</strong>"
                            } else {
                                if (s == 4) {
                                    n += "<strong> 0(积分抽奖)x" + r + "</strong>"
                                } else {
                                    n += "<strong>¥" + a + "x" + r + "</strong>"
                                }
                            }
                        }
                    }
                } else {
                    if (c.activityId != null && c.activityId != "0") {
                        n += "<strong>¥" + c.totalPrice + "</strong>"
                    } else {
                        n += "<strong>¥" + a + "x" + r + "</strong>"
                    }
                }
                if (s != 4 && (c.activityId == null || c.activityId == "0" || c.activityId == "-55")) {
                    if (b > 0) {
                        n += '<a href="javascript:void(0);" onclick="ajaxDeleteMiniCartItem(\'' + f + "','deleteWaringItem','" + c.productId + "','" + c.merchantId + "','" + c.promotionId + "','" + c.num + "');"
                    } else {
                        if (t && s == 0) {
                            n += '<a href="javascript:void(0);" onclick="ajaxDeleteMiniCartItem(\'' + f + "','deletePromote','" + c.productId + "','" + c.merchantId + "','" + c.promotionId + "','" + c.num + "');"
                        } else {
                            if (e == 3) {
                                n += '<a href="javascript:void(0);" onclick="ajaxDeleteMiniCartItem(\'' + f + "','deleteLandingpage','" + c.productId + "','" + c.merchantId + "','" + c.promotionId + "','" + c.num + "');"
                            } else {
                                n += '<a href="javascript:void(0);" onclick="ajaxDeleteMiniCartItem(\'' + f + "','deleteItem','" + c.productId + "','" + c.merchantId + "','" + c.promotionId + "','" + c.num + "');"
                            }
                        }
                    }
                    n += "return false;gotracker('2','delShop_" + f + "','" + c.productId + "')\">删除</a> </span> </li>"
                }
            });
            n += '<li class="pr_num">共<strong id="totalInFloatCart">' + l.totalNum + "</strong>件商品 金额总计(预估):<strong>";
            if (j && j > 0) {
                n += j + "积分（1号店）+"
            }
            if (i && i > 0) {
            ...
            n += k + "</strong>元</li></ul>";
            jQuery("#in_cart_num").text(l.totalNum);
            h.html(n)
        } else {
            jQuery("#in_cart_num").text("0");
            h.hide().html("");
    ...
    function ajaxDeleteMiniCartItem(o, m, n, k, j, p) {
        var i = URLPrefix.central;
        i = i + "/cart/ajax.do?action=delete&callback=?";
        var l;
        if (m == "deleteWaringItem") {
            l = {deleteWarningQueue: n, rd: Math.random()}
        } else {
            if (m == "deletePromote") {
                l = {deleteOverPromotionQueue: n, rd: Math.random()}
            } else {
                if (m == "deleteLandingpage") {
                    l = {deleteGiftQueue: "landingpage_" + j + "_0_" + k + "_" + n + "_" + p, rd: Math.random()}
                } else {
                    l = {deleteQueue: n, rd: Math.random()}
                }
            }
        }
        jQuery.getJSON(i, l, function (a) {
        });
        setTimeout(function () {
            reloadMiniCart()
        }, 2000)
    ...
    function initLeftMenu(h) {
        ...
        function g() {
            ...
            var b = typeof(httpUrl) != "undefined" ? httpUrl : "http://www.yihaodian.com";
            var a = typeof(merchant) != "undefined" ? merchant : 1;
            jQuery.getScript(b + "/product/ajaxGetGlobalLeftFloatMenuDataV3.do?callback=ajaxLeftFloatMenuDataV3&merchant=" + a)
        }

        function k() {
            var a = jQuery(".allsort_out_box").height();
            jQuery(".index_side_l").css("paddingTop", a);
            jQuery(".show_sort").css("min-height", a - 2);
            jQuery(".show_sort").css("height", a - 1)
        }
    ...
    function ajaxLeftFloatMenuDataV3(c) {
        submenuHtml = true;
        var d = {};
        jQuery(c.value).find("[category_id]").each(function () {
            d[jQuery(this).attr("category_id")] = jQuery(this).html()
        });
        jQuery(".allsort_out_box ul.allsort li").hover(function () {
            if (!jQuery(this).data("loaded")) {
                var a = jQuery(this).children(".show_sort");
                var b = d[a.attr("categoryId")];
                if (b) {
                    a.html(b).find(".show_sort_l dl").hover(function () {
                        jQuery(this).addClass("dl_cur")
                    }, function () {
                        jQuery(this).removeClass("dl_cur")
                    }).end().find("a[tk]").each(function () {
                        var f = jQuery(this).attr("tk");
                        if (f) {
                            jQuery(this).click(function () {
                                addTrackPositionToCookie("1", f)
                            })
                        }
                    }).end().find(".close_sort").click(function () {
                        a.hide()
                    });
                    delete d[a.attr("categoryId")]
                }
                jQuery(this).data("loaded", true)
            }
            jQuery(this).addClass("cur").children(".show_sort").show()
        }, function () {
            jQuery(this).removeClass("cur").children(".show_sort").hide()
        })
    }
    ...
    function setAddressCity(d) {
        var c = jQuery.cookie("provinceId");
        jQuery.cookie("provinceId", d, {domain: no3wUrl, path: "/", expires: 800});
        if (typeof currSiteType != "undefined" && currSiteType != 1) {
            jQuery.ajax({url: URLPrefix.central + "/header/addressChange.do?provinceId=" + d + "&timestamp=" + new Date() + "&callback=?", dataType: "jsonp", complete: function () {
                provinceSwitchProvince(d, c)
            }})
        } else {
            provinceSwitchProvince(d, c)
        }
    ...
    function provinceSwitchProvince(d, c) {
        jQuery.getJSON(URLPrefix.central + "/header/cartIsEmpty.do?provinceId=" + d + "&timestame=" + new Date() + "&callback=?", function (b) {
            if ("no" == b.value) {
                moveCartItem(d, c)
            } else {
                setAddressCityback(b)
            }
            var a = URLPrefix.central + "/globalsupport/getOneGrouponAreaIdByProviceId.do?provinceId=" + d + "&timestamp=" + new Date().getTime() + "&callback=?";
            jQuery.getJSON(a, function (f) {
            })
        })
    }
    ...
    function setAddressCityback() {
        ...
        if (s.indexOf("merchantID=") != -1) {
            s = s.substring(0, s.indexOf("merchantID=") - 1);
            window.location.href = s;
            return
        }
        if (s.indexOf("merchant=") != -1) {
            s = s.substring(0, s.indexOf("merchant=") - 1);
            window.location.href = s;
            return
        }
        if (s.indexOf("/tuangou/") != -1) {
            if (s.indexOf("/tuangou/myGroupon.do") != -1) {
                window.location.href = s
            }
            return
        }
        if (s.indexOf("openProvincePage=") != -1) {
            s = s.substring(0, s.indexOf("openProvincePage=") - 1);
            window.location.href = s;
            return
        }
        var E = /^\S*product\/\d+_?\d+/;
        if (s.match(E)) {
            if (s.indexOf("_") != -1) {
        ...
        var t = /^(http:\/\/){0,1}[^\/]+\/channel\/[0-9]+_[0-9]+\/$/;
        if (s.match(t)) {
        ...
        if (s.match(r)) {
            s = s.substring(0, s.lastIndexOf("&merchant"));
            window.location.href = s;
            return
        }
        var v = /^(http:\/\/){0,1}shop.yihaodian.com\/[^\/^_^\.]+\/[0-9]+\/{0,1}(\?[^\/]+)*$/;
        if (s.match(v)) {
            window.location.href = s;
            return
        }
        var y = /^(http:\/\/){0,1}www.yihaodian.com\/brand\/[0-9]+\/{0,1}(\?[^\/]+)*$/;
        if (s.match(y)) {
            window.location.href = s;
            return
        }
        var C = /^(http:\/\/){0,1}[^\/]+\/try\/[0-9]+\/{0,1}(\?[^\/]+)*$/;
        if (s.match(C)) {
        ...
        var z = /^(http:\/\/){0,1}[^\/]+\/try\/[0-9]+_[0-9]+\/{0,1}(\?[^\/]+)*$/;
        if (s.match(z)) {
            s = s.substring(0, s.lastIndexOf("_")) + "_0/";
            window.location.href = s;
            return
        }
        var D = /^(http:\/\/){0,1}www.yihaodian.com\/S-theme\/[0-9]+\/{0,1}(\?[^\/]+)*$/;
        if (s.match(D)) {
            window.location.href = s;
            return
        }
        var w = /^(http:\/\/){0,1}www.yihaodian.com\/ctg\/s2\/c([0-9]*)-([^?^\/]*)\/([0-9]*)\/$/;
        if (s.match(w)) {
            if (s.lastIndexOf("/") == s.length - 1) {
                s = s.substring(0, s.lastIndexOf("/"))
            }
        ...
        var x = /^(http:\/\/){0,1}search.yihaodian.com\/s2\/c([0-9]*)-([^?^\/]*)\/k([^?^\/]*)\/([0-9]*)\/$/;
        if (s.match(x)) {
            if (s.lastIndexOf("/") == s.length - 1) {
                s = s.substring(0, s.lastIndexOf("/"))
            }
        ...
        var F = /^(http:\/\/){0,1}channel\.[^\/]+\/[^\/^_^\.]+(\/[^\/^\.]+){0,1}\/[0-9]+\/{0,1}(\?[^\/]+){0,1}(#[^\/]+)*$/;
        if (s.match(F)) {
            if (s.indexOf("#") != -1) {
                s = s.substring(0, s.indexOf("#"))
            }
            if (s.indexOf("?") != -1) {
                var B = s.substring(s.indexOf("?"));
        ...
        if (s.indexOf("confirmOrder") != -1 && s.indexOf("saveOrder") != -1) {
            window.location.href = URLPrefix.central;
            return
        }
        var u = URLPrefix.search + "/s/";
    ...
    function moveCartItem(c, d) {
        jQuery.getJSON(URLPrefix.central + "/cart/globalMoveCartItem.do?provinceId=" + c + ((d) ? "&oldProvinceId=" + d : "") + "&timestamp=" + new Date().getTime() + "&callback=?", function (a) {
            setAddressCityback()
        })
    }

    function initProvince() {
        YHDGLOBAL.getCookie("provinceId", function (f) {
            var e = this["provinceId"];
            if (e && e > 0) {
                jQuery("#currProvince").text(jQuery("#p_" + e).text() + "站");
                var d = jQuery("#weibo");
                if (e == 2) {
    ...
    function showProvinces() {
        var b = URLPrefix.central + "/header/selectProvincebox.do?timestamp=" + new Date().getTime() + "&callback=?";
        jQuery.getJSON(b, function (a) {
            ...
            jQuery.getJSON(URLPrefix.central + "/header/cartIsEmpty.do?callback=?", function (d) {
                if ("no" == d.value) {
    ...
    function initPrompt() {
        jQuery("#changeReceiverGoodsCity").click(function () {
            var c = jQuery("#buyPromptDiv");
            var a = parseInt(c.css("top").replace("px", "")) + 75;
            var b = parseInt(c.css("left").replace("px", "")) + 225;
            jQuery("#receiverGoodsCityDiv").css("top", a + "px");
            jQuery("#receiverGoodsCityDiv").css("left", b + "px");
            jQuery(window).scroll(function () {
                var e = parseInt(c.css("top").replace("px", "")) + 75;
                var d = parseInt(c.css("left").replace("px", "")) + 225;
    ...
    function setPromptCookie() {
        ...
        if (typeof(promptExpireTime) == "undefined" && !jQuery("#promptExpireTime")) {
            ...
            c = jQuery("#promptExpireTime").val()
        }
        c = c ? c : 10;
        var b = new Date();
        var a = b.getTime() + c * 24 * 1000 * 3600;
        b.setTime(a);
        document.cookie = "prompt_flag=1;path=/;domain=." + no3wUrl + ";expires=" + b.toGMTString()
    };
    var suggestLength = 0;
    var curSuggestIndex = -1;

    function findNames(l, j, k) {
        var h = "0";
        if (jQuery("#leaf").size() > 0) {
            h = jQuery("#leaf").val()
        }
        var i = j.keyCode;
        if (jQuery(l).val() != k && i != "38" && i != "40") {
            var g = URLPrefix.search + "/get_keywords.do?keyword=" + encodeURIComponent(encodeURIComponent(jQuery(l).val())) + "&leaf=" + h + "&callback=?";
            jQuery.getJSON(g, function (a) {
                if (a.ERROR) {
                } else {
                    var b = false;
    ...
    function searchMe(n, l, m) {
        var i = null;
        var o = document.getElementById("recommendId");
        if (o) {
            i = o.value
        }
        var k = null;
        var p = document.getElementById("recommendName");
        if (p) {
            k = p.value
        }
        if (!n) {
            n = jQuery("#keyword").val()
        }
        if (n != null && n != "") {
            addKeywordHistory(n)
        }
        ...
        if (l != null && l != "0") {
            window.location = URLPrefix.search_keyword + "/s2/c" + l + "-" + m + "/k" + encodeURIComponent(encodeURIComponent(n)) + "/"
        } else {
            if (i != null && i != "") {
                window.location = URLPrefix.search_keyword + "/s2/c" + i + "-" + k + "/k" + encodeURIComponent(encodeURIComponent(n)) + "/"
            } else {
                window.location = URLPrefix.search_keyword + "/s2/c" + j + "-0/k" + encodeURIComponent(encodeURIComponent(n)) + "/"
            }
        }
    }
    ...
    function roll(l) {
        ...
        if (jQuery("#searchSuggest ul li").size() > 0) {
            ...
            if (k == "38" || k == "40") {
                var j = jQuery("#searchSuggest  ul li a").eq(curSuggestIndex).text();
                if (jQuery("#searchSuggest ul li").eq(curSuggestIndex).attr("id") != null && jQuery("#searchSuggest ul li").eq(curSuggestIndex).attr("id") != "") {
                    var h = jQuery("#searchSuggest  ul li a").eq(0).text();
                    jQuery("#keyword").val(h);
                    if (jQuery("#searchSuggest ul li ").eq(curSuggestIndex).attr("id") == "recom1") {
                        g = document.getElementById("recom1Id").value;
                        i = document.getElementById("recom1Name").value
                    }
                    if (jQuery("#searchSuggest ul li").eq(curSuggestIndex).attr("id") == "recom2") {
                        g = document.getElementById("recom2Id").value;
                        i = document.getElementById("recom2Name").value
                    }
                } else {
                    jQuery("#keyword").val(j)
                }
                document.getElementById("recommendId").value = g;
                document.getElementById("recommendName").value = i
            }
        }
        if (k == "13") {
            if (g != "") {
                searchMe(jQuery("#keyword").val(), g, i)
            } else {
    ...
    function hotKeywords_onDocumentReady() {
        ...
        var hotkeywordsList = divHotkeywordsList.innerHTML;
        ...
        if (def.length > 0) {
            ...
            if (oldKeywords == keywords || oldKeywords == "") {
        ...
        if (curr.length > 0) {
            ...
            jQuery("#hotKeywordsShow").html(buf);
    ...
    (function (b) {
        b.fn.bgIframe = b.fn.bgiframe = function (f) {
            if (b.browser.msie && parseInt(b.browser.version) <= 6) {
                f = b.extend({top: "auto", left: "auto", width: "auto", height: "auto", opacity: true, src: "javascript:false;"}, f || {});
                var e = function (c) {
    ...
    if (typeof currSiteType != "undefined" && currSiteType == 2) {
        _indexUrl = URLPrefix.mall;
        _my = URLPrefix.mymall
    }
    function executiveLandedCheck() {
        var b = jQuery.cookie("ut");
        var a = 0;
        if (b) {
            a = 1
        }
        if (a == 0) {
            yhdPublicLogin.showLoginDivNone(URLPrefix.passport, false, "", function (c) {
                if (c == 0) {
    ...
    function submitFavorite(c, a) {
        executiveLandedCheck();
        var b = URLPrefix.my + "/member/myCollection/addFavorite.do?tag.productID=" + c + "&tag.merchantID=" + a + "&callback=?";
        jQuery.getJSON(b, function (d) {
            if (d.ERROR) {
            } else {
                showFavoriteResult(d)
            }
        })
    }

    function showFavoriteResult(b) {
        var a = b.code;
        if (a == 0) {
            var d = 0;
            var c = 0;
            var e = URLPrefix.my + "/member/myCollection/getPopboxInfo.do?callback=?";
            jQuery.getJSON(e, function (g) {
                if (g.ERROR) {
                } else {
                    YHD.popwin(g.value, 460, 349);
                    var f = "";
                    jQuery(".fkey li a").click(function () {
                        var h = jQuery(this).attr("flag");
                        if (h == "false") {
                            jQuery(this).addClass("on");
                            f = f + " " + jQuery(this).text();
                            jQuery("#tagName").attr("value", jQuery.trim(f));
                            jQuery(this).attr("flag", "true")
                        } else {
                            jQuery(this).removeClass("on");
                            jQuery(this).attr("flag", "false");
                            var j = "";
                            var k = jQuery.trim(jQuery("#tagName").attr("value")).split(" ");
                            for (var i = 0; i < k.length; i++) {
                                if (k[i] != jQuery(this).text()) {
                                    j = j + " " + k[i]
                                }
                            }
                            jQuery("#tagName").attr("value", jQuery.trim(j));
                            f = jQuery("#tagName").attr("value")
                        }
                    });
                    if (jQuery("#checkFlag").checked) {
                        c = 1
                    }
                    jQuery("#addTag_confirm").click(function () {
                        submitpTag(b.productID, b.merchantID, c)
                    })
                }
            })
        } else {
            if (a == 1) {
                ...
                if (a == 3) {
                    ...
                    if (a == 4) {
                        YHD.alert("包含非法词汇，操作无法完成！")
                    } else {
                        if (a == 5) {
                            window.location.href = _indexUrl + "/passport/login_input.do?returnUrl=" + encodeURIComponent(window.location.href)
                        } else {
                            if (a == 6) {
                                window.location.href = URLPrefix.central + "/product/cart.do?action=view"
                            }
                        }
                    }
                }
    ...
    function submitpTag(b, d, c) {
        jQuery(".popwinClose").click();
        var a = jQuery("#tagName").val();
        if (a == "") {
            return
        }
        if (jQuery.trim(a) != "") {
            var f = a.split(" ");
            if (f.length > 3) {
                YHD.alert("每次最多输入三个标签");
                return
            } else {
                for (var g = 0; g < f.length; g++) {
                    if (f[g].length > 10) {
                        YHD.alert("标签名字过长，每个标签不能超过10个汉字或字符");
                        return
                    }
                }
            }
        ...
        var e = URLPrefix.my + "/member/myCollection/addProductTag.do?tag.productID=" + b + "&tag.merchantID=" + d + "&tag.name=" + encodeURIComponent(encodeURIComponent(jQuery.trim(a))) + "&tag.checkFlag=" + c + "&callback=?";
        jQuery.getJSON(e, function (h) {
            if (h.ERROR) {
            } else {
                showEditFavoriteResult(h)
            }
        })
    }
    ...
    function showEditFavoriteResult(a) {
        if (a.code == 5) {
            jQuery(".popwinClose").click();
            YHD.alert("标签已经添加过该商品")
        } else {
            if (a.code == 0) {
                if (jQuery.trim(jQuery("#collectionProductAll").html()) != "") {
                    window.location = _my + "/member/myCollection/myCollectionProduct.do"
                } else {
                    jQuery(".popwinClose").click();
                    YHD.alert("该商品标签已添加成功！")
                }
            }
        }
    };
    ...
    function appearExperience(i, h, f) {
        var g = jQuery.cookie("ut");
        if (!g) {
            ...
            var j = URLPrefix.central + "/product/checkItemCount.do?productID=" + i + "&callback=?";
            jQuery.getJSON(j, function (a) {
                if (a.ERROR) {
                } else {
                    apperarSuccess(a, i)
                }
    ...
    function apperarSuccess(f, g) {
        ...
        if (f.value == 0) {
            ...
            YHD.popwin(a.html(), 466, 283);
            return
        }
        var h = URLPrefix.my + "/member/exp/showProductExcerienceDiv.do?productId=" + g + "&callback=?";
        jQuery.getJSON(h, function (b) {
            if (b.ERROR) {
            } else {
                if ((navigator.userAgent.indexOf("MSIE") >= 0) && (navigator.userAgent.indexOf("Opera") < 0)) {
                    YHD.popwin(b.value, 460, 415)
                } else {
                    YHD.popwin(b.value, 460, 439)
                }
    ...
    function deployExperience(n, s) {
        var r = /<[^> ]+>/;
        var v = URLPrefix.central + "/product/deployExperience.do?productID=" + shareProductId + "&merchantID=" + shareMerchantId + "&action=create";
        var p = jQuery("#contentTitle").val();
        if (p && "" != jQuery.trim(p)) {
            p = p.replace(/(^\s*)|(\s*$)/g, "");
            if (p.length > 15) {
        ...
        v = v + "&title=" + encodeURIComponent(encodeURIComponent(p));
        var l = true;
        jQuery(".ipt3").each(function (d) {
            var a = jQuery(this).attr("nullTitile");
            var e = jQuery(this).attr("categoryTitile");
            var b = jQuery(this).attr("experienceTitle");
            var c = jQuery(this).val().replace(/(^\s*)|(\s*$)/g, "");
            if (c == "") {
                showErrorTitle(a, "请写写这个商品的" + a + "!");
                this.focus();
                l = false;
                return false
            }
            if (c.length > 200) {
                showErrorTitle(a, "请将您输入的" + a + "字数超出200个字的字数限制!");
                l = false;
                return false
            }
            if (r.exec(c)) {
                showErrorTitle(a, a + "您输入的格式有误!");
                l = false;
                return false
            }
            v = v + "&" + e + "=" + encodeURIComponent(encodeURIComponent(c)) + "&" + b + "=" + encodeURIComponent(encodeURIComponent(a))
        });
        if (l) {
            var u = jQuery("#stars1-input");
            var o = "5";
            if (u.val() != "" && u.val() != null) {
                o = u.val()
            }
            var q = "5";
            var m = "5";
            var t = jQuery("#u_realName").text();
            if (t && "" != jQuery.trim(t)) {
                t = t.replace(/(^\s*)|(\s*$)/g, "")
            } else {
                t = jQuery("#userRealName").val();
                if (t && "" != jQuery.trim(t)) {
                    t = t.replace(/(^\s*)|(\s*$)/g, "")
                } else {
            ...
            v = v + "&qualityRating=" + o + "&deliveryRating=" + q + "&serviceRating=" + m + "&userRealName=" + encodeURIComponent(encodeURIComponent(t)) + "&callback=?";
            jQuery.getJSON(v, function (a) {
                if (a.ERROR) {
                } else {
                    showShareDeployPage(a)
                }
            });
            return true
        } else {
    ...
    function showDeployPage(e) {
        var h = e.value.split("=");
        var f = h[0];
        var g = h[1];
        if (f == 1) {
            jQuery(".popwinClose").click();
            YHD.alert(g, null, 476, 27)
        } else {
            YHD.alert(g, null, 476, 27)
        }
    ...
    function apperarShareSuccess(f, g) {
        if (f.value == -1) {
            yhdPublicLogin.showLoginDivNone(URLPrefix.passport, false, "", function (b) {
                if (b == 0) {
                    yhdPublicLogin.showTopLoginInfo()
                }
            });
        ...
        var h = URLPrefix.my + "/member/exp/showProductExcerienceDiv.do?productId=" + g + "&merchantId=" + shareMerchantId + "&soId=" + shareOrderId + "&callback=?";
        jQuery.getJSON(h, function (c) {
            if (c.value == null || c.value == "" || c.ERROR) {
            } else {
                YHD.popwin(c.value);
                YHD.popwin(c.value, jQuery(".popbox").width(), jQuery(".popbox").height());
                jQuery(".popbox").bgiframe();
                new Stars("stars1");
                var b = jQuery("#experience_info").attr("soid");
                ...
                jQuery("[name=experience.submit]").click(function () {
                    shareMerchantId = jQuery("#experience_info").attr("merchantid");
                    deployShareExperience(shareProductId, shareMerchantId, b)
                })
            }
        })
    }

    function deployShareExperience(p, x, w, s) {
        shareProductId = p;
        shareMerchantId = x;
        var v = /<[^> ]+>/;
        var z = URLPrefix.central + "/product/deployExperience.do?productID=" + p + "&merchantID=" + x + "&action=create&soId=" + w;
        var r = jQuery("#contentTitle").val();
        if (r && "" != jQuery.trim(r)) {
            r = r.replace(/(^\s*)|(\s*$)/g, "");
            if (r.length > 15) {
        ...
        z = z + "&title=" + encodeURIComponent(encodeURIComponent(r));
        var n = true;
        var t = "#yhd_pop_win .ipt3,#yhd_pop_win .ipt6";
        if (s && s == "publishExperience") {
            t = "#publishExperience .ipt3,#publishExperience .ipt6"
        }
        jQuery(t).each(function (b) {
            var d = jQuery(this).attr("nullTitile");
            var c = jQuery(this).attr("categoryTitile");
            var e = jQuery(this).attr("experienceTitle");
            var a = jQuery(this).val().replace(/(^\s*)|(\s*$)/g, "");
            if (a == "") {
                if (c == "contentGood") {
            ...
            z = z + "&" + c + "=" + encodeURIComponent(encodeURIComponent(a)) + "&" + e + "=" + encodeURIComponent(encodeURIComponent(d))
        });
        if (n) {
            var q = getStartvalue("#stars1-input");
            var u = 5;
            var o = 5;
            var y = 5;
            if (jQuery("#stars_logi-input").size() > 0 && jQuery("#stars_atti-input").size() > 0 && jQuery("#stars_desc-input").size() > 0) {
                u = getStartvalue("#stars_logi-input");
                o = getStartvalue("#stars_atti-input");
                y = getStartvalue("#stars_desc-input")
            }
            jQuery("[name=experience.submit]").css("disabled", true);
            z = z + "&qualityRating=" + q + "&deliveryRating=5&serviceRating=5&mdeliveryPoint=" + u + "&mservicePoint=" + o + "&mdescriptPoint=" + y + "&callback=?";
            jQuery(".evaBtn").attr("disabled", "disabled");
            jQuery.getJSON(z, function (a) {
                jQuery(".evaBtn").removeAttr("disabled");
                if (a.ERROR) {
                } else {
                    jQuery(".popwinClose").click();
                    showShareDeployPage(a, s)
                }
            });
            return true
        } else {
    ...
    function getStartvalue(f) {
        var e = jQuery(f);
        var d = "5";
        if (e && e.val() != "" && e.val() != null) {
            d = e.val()
        }
        return d
    }

    function showErrorTitle(c, d) {
        jQuery("#" + c).css({color: "#666", display: "inline-block", height: "23px", "line-height": "23px", padding: "0 5px", border: "1px solid #FF8080", "background-color": "#FFF2F2"});
        jQuery("#" + c).html(d);
        setTimeout(function () {
            jQuery("#" + c).removeAttr("style");
            jQuery("#" + c).html("")
        }, 9000)
    }

    function showShareDeployPage(g, k) {
        var l = g.value.split("=");
        var h = l[0];
        var i = l[1];
        if (h == 1) {
            jQuery(".popwinClose").click();
            window.scrollTo(0, 0);
            var j = '<div class="popup_cont"><div class="prompted"><img src="' + URLPrefix.statics + '/member/images/okay.png"/><h3>提交成功！ </h3><p>' + i + '!</p></div><p class="countdown">3秒后自动关闭</p><a href="javascript:void(0);" class="close">关闭</a></div>';
            popMsg(j, ".popup_cont .close", 378, 120);
            ...
            setTimeout(function () {
                ...
                openShare();
                if (k && k == "publishExperience") {
                    jQuery("#contentTitle").attr("value", "");
                    jQuery(".ipt3, .ipt6").each(function (a) {
            ...
            if (h == 2) {
                var j = '<div class="popup_sens"><h3 class="title">提示<span class="close">关闭</span></h3><p class="popup_text">' + i + '</p><p class="btntip"><input type="button" value="确 定" /></p></div>';
                popMsg(j, ".popup_sens .close,.btntip :button", 398, 150, 250);
                ...
                var j = '<div class="popup_sens"><h3 class="title">提示<span class="close">关闭</span></h3><p class="popup_text">' + i + '</p><p class="btntip"><input type="button" value="确 定" /></p></div>';
                popMsg(j, ".popup_sens .close,.btntip :button", 398, 150);
                if (k && k == "publishExperience") {
                    jQuery("#contentTitle").attr("value", "");
                    jQuery(".ipt3, .ipt6").each(function (a) {
                        jQuery(this).attr("value", "")
    ...
    function popMsg(l, i, k, g, j) {
        YHD.init();
        var h = jQuery("#yhd_pop_win");
        if (l != null) {
            jQuery(h).html(l)
        }
        if (j) {
            YHD.initPosition(h, k, g, j)
        } else {
            YHD.initPosition(h, k, g)
        }
        jQuery(h).jqm({overlay: 10, overlayClass: "pop_win_bg", modal: true, toTop: true}).jqmShow().jqmAddClose(i)
    }

    function appearAndShareExperience(l, k, h, j, m) {
        productname = m;
        ...
        if (!i) {
            ...
            var n = URLPrefix.central + "/product/checkItemCount.do?productID=" + l + "&merchantId=" + shareMerchantId + "&soId=" + shareOrderId + "&callback=?";
            jQuery.getJSON(n, function (a) {
                if (a.ERROR) {
                } else {
                    apperarShareSuccess(a, l)
                }
            })
        }
    }
    ...
    function openShare() {
        ...
        var b = URLPrefix.my + "/member/exp/editShareExcerienceDiv.do?productId=" + shareProductId + "&callback=?";
        jQuery.getJSON(b, function (a) {
            if (a.ERROR) {
            } else {
                if (a.value != "noshare") {
                    getSinaUrl(function (f) {
                        YHD.popwin(a.value, 470, 400);
                        ...
                        jQuery("[name='product_share_experience']").val(shareContentgood + f);
                        jQuery("[name=experience.share]").click(function () {
                            if (jQuery("[name='product_share_experience']").val().length > 140) {
                                ...
                                if (jQuery("[name='product_share_experience']").val().length == 0) {
                                    ...
                                    var c = false;
                                    jQuery(":checkbox[name^='share_to_']").each(function (d) {
                                        c = c || jQuery(this).attr("checked")
                                    });
                                    if (c) {
    ...
    function getShotURL(d, c) {
        if (d == "sina" && sinaUrl != "") {
            c(sinaUrl)
        } else {
            url = URLPrefix.passport + "/share/shotUrl.do?longUrl=" + escape(URLPrefix.central + "/product/" + shareProductId + "?tarcker_u=" + getpcode(d)) + "&callback=?";
    ...
    function perpShareExcerience(b) {
        ...
        validateShare(b, "sina");
        validateShare(b, "renren");
        validateShare(b, "qq");
        validateShare(b, "kaixin");
        jQuery(".popwinClose").click();
        YHD.alert("评论并且分享成功", null, 476, 27)
    }

    function validateShare(d, c) {
        if (jQuery(":checkbox[name='share_to_" + c + "']") && jQuery(":checkbox[name='share_to_" + c + "']").attr("checked")) {
            shareExcerience(d, c)
        }
    }

    function createShareUrl(h, g, f) {
        var e = URLPrefix.passport + "/share/" + g + "/publish.do?sign=" + sig + "&exid=" + exid + "&productId=" + shareProductId + "&pubMessage.content=" + shareMsg + "&pubMessage.title=" + encodeURIComponent(encodeURIComponent("在一号店发布了购买体验")) + "&pubMessage.image=" + escape(shareImage_url) + "&pubMessage.url=" + escape(f) + "&sinaUrl=" + escape(sinaUrl) + "&callback=?";
        return e
    }

    function shareExcerience(d, c) {
        getShotURL(c, function (a) {
            jQuery.getJSON(createShareUrl(d, c, a), function (b) {
            })
        })
    };
    ...
    Stars.prototype = {initialize: function (j, e) {
        this.SetOptions(e);
        var m = 999;
    ...
    function writeHeaderContent() {
        YHDGLOBAL.getCookie(["ut", "uname"], function () {
            var f = this["ut"];
            var e = this["uname"];
            var d = 0;
            if (f) {
            ...
            YHDGLOBAL.getCookie(["ucocode", "externaluserlevel"], function () {
                var h = "";
                var c = this["ucocode"];
                var b = this["externaluserlevel"];
                if ((c && c == "pingan")) {
                    hasPingAnCookie = 1;
                    h = "尊敬的万里通会员";
    ...
    function hightLightMenu(f, g) {
        ...
        e.each(function (b) {
            ...
            if (!a) {
                a = (h.indexOf("point2channel.do") > -1) && (d.indexOf("/point2/pointIndex.do") > -1)
            }
            if (a) {
                if (b) {
    ...
    jQuery(function () {
        if (jQuery.cookie("ut")) {
            var p = 0;
            var o = URLPrefix.central + "/top/myorder/ajaxInitShowMyOrderPageTotalData.do?timestame=" + new Date() + "&callback=?";
            jQuery.getJSON(o, function (a) {
                if (!(a && a.resultCode) || a.resultCode == 0) {
                    ...
                    jQuery(".top_bar_link>ul>li:first").data("isLogin", false);
                    return false
                } else {
                    r(a)
                }
            ...
            function s(b) {
                var a = b.orderNum;
                var c = b.payReceiveNum;
                if (c == 0) {
                    jQuery("#odrNumId").remove()
                }
                if (c + p > 0) {
                    jQuery("#tagPageOdrNumId").html(c);
                    jQuery("#odrNumId").addClass("odrNum").show();
                    jQuery("#idxOdrTipConId").removeClass("idxOdrTipCon").hide();
                    jQuery(".top_bar_link>ul>li:first").addClass("firstLi");
                    jQuery(".top_bar_link>ul>li:first").hover(function () {
                        if (new Date().getTime() - jQuery(".top_bar_link>ul>li:first").data("reqedtime") <= 1 * 60 * 1000) {
                            return
                        }
                        if (jQuery(".top_bar_link>ul>li:first").data("inreq")) {
                            return
                        }
                        jQuery(".top_bar_link>ul>li:first").data("inreq", true);
                        jQuery(".loading").show().siblings().hide();
                        jQuery(".tabCon:gt(0)").children().not(".loading").hide();
                        jQuery("#idxOdrTipConId").removeClass("idxOdrTipCon").hide();
                        jQuery.getJSON(URLPrefix.central + "/top/myorder/ajaxShowMyOrderPageTagData.do?timestamp=" + new Date() + "&callback=?", function (d) {
                            if (d.ERROR) {
                                jQuery(".top_bar_link>ul>li:first").data("inreq", false);
                                jQuery(".top_bar_link>ul>li:first").data("reqedtime", new Date().getTime());
                                return
                            }
                            jQuery(".top_bar_link>ul>li:first").data("inreq", false);
                            jQuery(".top_bar_link>ul>li:first").data("reqedtime", new Date().getTime());
                            ...
                            jQuery("#idxOdrTipConId ul li:eq(2)").attr("id", "waitCommentId_" + p);
                            t();
                            q();
            ...
            function m() {
                jQuery(".top_bar_link>ul>li:first,#idxOdrTipConId").hover(function () {
                    jQuery(".top_bar_link>ul>li:first").addClass("myOdrHover");
                    jQuery("#idxOdrTipConId").addClass("idxOdrTipCon").show();
                    jQuery("#odrNumId").removeClass("odrNum").hide()
                }, function () {
                    jQuery(".top_bar_link>ul>li:first").removeClass("myOdrHover");
                    jQuery("#idxOdrTipConId").removeClass("idxOdrTipCon").hide();
                    jQuery("#odrNumId").addClass("odrNum").show()
                })
            }
            ...
            function q() {
                var c = jQuery("#idxOdrTipConId ul li:eq(0)").attr("id");
                var b = jQuery("#idxOdrTipConId ul li:eq(1)").attr("id");
                var a = jQuery("#idxOdrTipConId ul li:eq(2)").attr("id");
                var d = jQuery("#idxOdrTipConId ul li:eq(0)");
                if (c && c.split("_")[1] > 0) {
                    l(d)
                } else {
                    if (b && b.split("_")[1] > 0) {
                        d = jQuery("#idxOdrTipConId ul li:eq(1)");
                        l(d)
                    } else {
                        if (a && a.split("_")[1] > 0) {
                            d = jQuery("#idxOdrTipConId ul li:eq(2)");
                            l(d)
                        } else {
                            jQuery(".top_bar_link>ul>li:first").removeClass("myOdrHover");
                            jQuery("#idxOdrTipConId").removeClass("idxOdrTipCon").hide();
            ...
            function t() {
                if (p == 0) {
                    ...
                    jQuery("#idxOdrTipConId ul li:eq(2)").html("待评论(" + p + ")");
                    jQuery("#pageTagUnCommentId").html(p)
                }
            }

            function r(a) {
                jQuery.getJSON(URLPrefix.my + "/member/exp/getUserUnCommentNumJson.do?callback=?", function (b) {
                    if (b.ERROR) {
                        p = 0
                    }
                    p = b.awaitComment;
    ...
    yhdHead.topMenuImgLazyLoad = function () {
        jQuery("#global_menu li img").each(function () {
    ...
    yhdHead.newTopTabShow = function (b, a) {
        if (b > a) {
            jQuery("#global_menu li").each(function (c) {
                if (c == a - 1) {
    ...
    yhdHead.dealWideNarrowScreen = function () {
        var b = screen.width >= 1280;
        if (currSiteId == 1) {
            var a = jQuery("#global_menu li").length;
            var c = jQuery("#global_menu span").length;
            if (!b) {
                yhdHead.newTopTabShow(a, 10);
                yhdHead.oldTopTabShow(c, 10)
            } else {
                if (isIndex) {
                    if (isIndex == 1) {
                        yhdHead.newTopTabShow(a, 10)
    ...
    yhdHead.topRightPicAdv = function () {
        if (currSiteId == 1) {
            if (isIndex == 1 && (screen.width >= 1280) && jQuery(".wrap").width() > 980) {
                jQuery("#headerTopRightAdId img").attr("src", function () {
                    return jQuery(this).attr("original")
                }).removeAttr("original");
                jQuery("#headerTopRightAdId").show()
            }
        }
    };
    jQuery(function () {
        yhdHead.dealWideNarrowScreen();
        yhdHead.topMenuImgLazyLoad();
        yhdHead.topRightPicAdv();
    ...
    $(document).ready(function () {
        if (currSiteId && currSiteId == 1) {
            ...
            if (jQuery("#global_menu a[href='http://www.111.com.cn']").size()) {
                jQuery("#global_menu a[href='http://www.111.com.cn']").attr("href", "###").removeAttr("target").bind("click", yw_click)
            } else {
                jQuery("#global_menu a[href='http://www.111.com.cn/']").attr("href", "###").removeAttr("target").bind("click", yw_click)
            }
            if (jQuery("#global_menu a[href='http://www.yiwang.cn']").size()) {
                jQuery("#global_menu a[href='http://www.yiwang.cn']").attr("href", "###").removeAttr("target").bind("click", medical_click)
            } else {
                jQuery("#global_menu a[href='http://www.yiwang.cn/']").attr("href", "###").removeAttr("target").bind("click", medical_click)
            }
        }
    ...
    function medical_click() {
        var e = "target_site=2";
        var h = "https://passport.yihaodian.com/auth/redirect.do?" + e + "&callback=?";
        var f = "http://www.yiwang.cn/";
    ...
    function yhd_click() {
        var d = "https://passport.111.com.cn/auth/revertToYhd.do?callback=?";
        var e = "http://www.yihaodian.com";
        if (!checkLogin_for_auth()) {
    ...
    yhdPublicLogin.getCookie = function (c) {
    ...
    yhdPublicLogin.showLoginDiv = function (b, a) {
        if (a && yhdPublicLogin.checkLogin()) {
            return
        }
        passportLoginFrame(URLPrefix.passport, null, function (g) {
            try {
                if (b) {
                    var d = "";
    ...
    yhdPublicLogin.showLoginDivNone = function (c, d, b, a) {
        if (d && yhdPublicLogin.checkLogin()) {
            return
        }
        passportLoginFrame(c, b, a)
    };
